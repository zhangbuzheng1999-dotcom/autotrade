...
FIELD_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "time": ("time", "datetime", "end_time", "timestamp", "date"),
    ...
    "underlying_price": ("underlying_price", "underlying_close"),
    "forward_price": ("forward_price", "forward"),
    "risk_free_rate": ("risk_free_rate", "r", "rate"),
    "time_to_expiry": ("time_to_expiry", "ttm", "t"),
    "market_iv": ("market_iv",),
    "surface_iv": ("surface_iv", "iv"),
    "delta": ("delta",),
    "gamma": ("gamma",),
    "vega": ("vega",),
    "theta": ("theta",),
