"""Build standard TimeSlice objects from live market callbacks."""
...
class LiveTimeSliceBuilder:
    ...
    def push(
        ...
        *,
        ...
        when = _data_time(data, self.clock)
...
def _data_time(data, clock) -> datetime:
